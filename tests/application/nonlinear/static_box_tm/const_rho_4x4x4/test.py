...
def test() :
  ...
  ranks = 1
  launch = os.path.join(PTATIN_DIR,PETSC_ARCH,'bin','ptatin_driver_nonlinear_ts.app') + ' -options_file ' + os.path.join(PTATIN_DIR,'src','models','static_box_thermomech','examples','staticbox-ex1.opts')
