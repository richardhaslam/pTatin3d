...
\begin{enumerate}
	...
	%%%%%%%%%%%%
	\item {\it Convergence failure of the viscous block}. See below.
	%%%%%%%%%%%%
\end{enumerate}
...
\begin{enumerate}
	...
	%%%%%%%%%%%%
	\item {\it MG coarse grid solver fails to converge}. Possible fixes: (1) Improve the coarse grid solver. See below.
	%%%%%%%%%%%%
\end{enumerate}
