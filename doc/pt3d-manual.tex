...
\def\printtitle{%						
    {
    	\centering \@title\par}
		 	\vspace{10mm}
	\begin{figure} [hbtp]
	\includegraphics[height=0.4\textheight]{pt3d_coordinate_system.pdf}
	\end{figure}
    }
...
\author{
		Dave A, May \\	
		Institute of Geophysics, ETH Z{\"u}ruch\\
...
\begin{figure} [hbtp]
\center
%\includegraphics[height=0.4\textheight]{pt3d_solver.pdf}
\caption[\itshape ]
