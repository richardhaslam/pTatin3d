...
*/
	...
	/*V and P*/
	stokes_pack = c->stokes_ctx->stokes_pack;			
//	ierr = Subduction_Initiation2d_Output_VP(c,stokes_pack,X,prefix);CHKERRQ(ierr);
...
//		ierr = Subduction_Initiation2d_Output_Temperature(c,volQ,daT,temperature,prefix);CHKERRQ(ierr);
	}

	ierr = DMCompositeGetEntries(stokes_pack,&dau,&dap);CHKERRQ(ierr);
	
//	ierr=Subduction_Initiation2d_Output_Viscosity(c,dau,materialpoint_db,prefix);
