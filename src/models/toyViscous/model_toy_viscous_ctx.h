 ...
 **
 **    Project:       pTatin3d
 **    Filename:      model_toy_viscous_ctx.h
 **
 **
...
#ifndef __ptatin3d_model_toy_viscous_ctx_h__
#define __ptatin3d_model_toy_viscous_ctx_h__

/* define user model */
typedef struct {
	PetscReal Lx,Ly,Lz,htop,hbot;
	PetscReal notch_width,notch_height,notch_base,dxn,dyn,beta,damage,buffer;
	PetscReal vx_up,vx_down,vybottom,rhotop,rhobot,etatop,etabot,eps1,eps2;
    PetscInt  nmaterials;
    PetscBool runmises;
