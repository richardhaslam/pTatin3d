...
extern PetscErrorCode pTatinModelRegister_rift_fastscape_3D(void);
extern PetscErrorCode pTatinModelRegister_SPtest(void);
...
PetscErrorCode pTatinModelRegisterAll(void)
{
	...
	ierr = pTatinModelRegister_rift_fastscape_3D();CHKERRQ(ierr);
	ierr = pTatinModelRegister_SPtest();CHKERRQ(ierr);
