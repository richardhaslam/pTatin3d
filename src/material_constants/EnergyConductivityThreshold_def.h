/*
  ...
  on geop-318.ethz.ch, at 2015-09-22 10:11:03.344790 by dmay
*/
...
PetscErrorCode MaterialConstantsSetValues_ConductivityThreshold(const int region_id,EnergyConductivityThreshold _data[],double k0,double k1,double T_threshold);
PetscErrorCode MaterialConstantsScaleValues_ConductivityThreshold(const int region_id,EnergyConductivityThreshold _data[],double k0,double k1,double T_threshold);
