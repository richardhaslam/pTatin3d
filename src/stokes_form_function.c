...
#undef __FUNCT__
#define __FUNCT__ "FormFunction_StokesVE"
PetscErrorCode FormFunction_StokesVE(SNES snes,Vec X,Vec F,void *ctx)
{
  PetscErrorCode    ierr;
  pTatinCtx         ptatin;
  DM                stokes_pack,dau,dap;
  DMDALocalInfo     infou,infop;
  Vec               Uloc,Ploc,FUloc,FPloc,u,p,Fu,Fp;
  PetscScalar       *LA_Uloc,*LA_Ploc,*LA_FUloc,*LA_FPloc;
  PhysCompStokes    stokes;
  ...
  ierr = FormFunctionLocal_U(stokes,dau,LA_Uloc,dap,LA_Ploc,LA_FUloc);CHKERRQ(ierr);
  //ierr = FormFunctionLocal_U_tractionBC(stokes,dau,LA_Uloc,dap,LA_Ploc,LA_FUloc);CHKERRQ(ierr);
  ierr = FormFunctionLocal_U_DivSymTens(stokes,dau,LA_Uloc,dap,LA_Ploc,LA_FUloc);CHKERRQ(ierr);
