...
print MYFILE "\n";
print MYFILE "  #define PTATIN_SVN_REPO_UUID        \"@lines_info[3]\"\n";
print MYFILE "  #define PTATIN_SVN_REPO_REV         \"@lines_info[4]\"\n";
print MYFILE "  #define PTATIN_SVN_REPO_LAST_CHANGE \"Log: @lines_log[1]\"\n";
print MYFILE "\n";
print MYFILE "#endif \n";
print MYFILE "\n";
